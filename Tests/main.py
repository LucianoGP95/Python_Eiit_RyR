...
button3 = tk.Button(frame, text='Go', command=lambda: print(source_dirname), state='disabled')
button3.grid(row=5, column=0, padx=5, pady=5)

# create the button to realize the extraction
button4 = tk.Button(frame, text='Test', command=lambda: print(selected_option.get()))
button4.grid(row=6, column=0, padx=5, pady=5)

# Bind different actions to activate the or deactivate the Go button if conditions ar met
