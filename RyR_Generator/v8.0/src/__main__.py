...
def askdirectory(text_field):
    '''Opens a dialog window to select the source directory'''
...
button3 = tk.Button(frame, text='Go', command=lambda: nest_number(selected_option, options, source_dirname, target_dirname, source_dirname), state='disabled')
